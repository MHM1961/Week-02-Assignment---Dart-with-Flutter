void main(){
//declaration of variable num_1 thats storing an interger number
int num_1 = 9;

//declaration of variable num_2 thats storing an float point number
double num_2 = 18.6;

//declaration of variable fullName thats storing an name
...
//dart functions for printing output
print(num_1);
print(num_2);print(numbers);
print(scores);
